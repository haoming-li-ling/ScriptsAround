...
L0prop <- memoise(function(n, e, u, i) {
  if (u == 5) {
    return(between(i)(n) * JointProba(n, e))
  } else {
    return(between(u)(n) * JointProba(n, e))
  }
})
...
U1 <- memoise(function(u, e, i) {
  Sum(0:(nworlds - 1), function(n) {
    if (P_n_given_e(n, e) == 0) {
      ...
      return(P_n_given_e(n, e) * log(L0(n, e, u, i)))
    }
  }) - cost(u)
})
...
U1table <- function(i) {
  outer(0:(nepis - 1), 0:(nmessages - 1), Vectorize(function(e, u) {
    U1(u, e, i)
  }))
}
...
L1prop <- memoise(function(n, e, u) {
  JointProba(n, e) * Sum(0:4, function(i) {
    Prob_i(i) * S1(u, e, i)
  })
})
...
L <- memoise(function(k, n, e, u) {
  if (k == 1) {
    ...
    return(Lprop(k, n, e, u) / Lnorm(k, u))
  }
})
